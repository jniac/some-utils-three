...
import { isMatrix4, isObject3D, isVector3 } from 'xxx';
/**
 * NOTE:
...
export function update3d(container, div, camera, target, { pixelPerUnit = 100, resetRotation = 0, resetScale = 0, leftHanded = false, } = {}) {
