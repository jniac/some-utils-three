import { Box3, BufferGeometry, Color, ColorRepresentation, LineBasicNodeMaterial, LineSegments, Vector3 } from 'three/webgpu';
...
export declare class LineHelper extends LineSegments<BufferGeometry, LineBasicNodeMaterial> {
    points: Vector3[];
     ...
     */
    constructor(reservePoints?: number);
    /**
