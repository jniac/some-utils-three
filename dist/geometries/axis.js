import { BufferAttribute, BufferGeometry, CircleGeometry, Color, ConeGeometry, CylinderGeometry, SphereGeometry } from 'three';
...
function createAxisGeometry(options) {
    const { axis, length, radius, radialSegments, coneRatio, radiusScale, vertexColor, baseCap, color, align, } = { ...defaultAxisOptions, ...options };
...
export class AxesGeometry extends BufferGeometry {
    ...
    constructor(options) {
        super();
        const { xColor, yColor, zColor, ...axisOptions } = { ...defaultAxesOptions, ...options };
