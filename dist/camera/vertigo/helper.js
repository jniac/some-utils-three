import { DoubleSide, LineBasicMaterial, Mesh, MeshBasicMaterial, PlaneGeometry, Texture } from 'three';
import { LineHelper } from '../../helpers/line.js';
function texture() {
    const create = () => {
...
export class VertigoHelper extends LineHelper {
    constructor(vertigo, { color = '#ffff00' } = {}) {
        ...
        this
            ...
            .plus([0, 0], .5)
            .draw();
        const plane = new Mesh(new PlaneGeometry(1, .25), new MeshBasicMaterial({
            color,
            alphaMap: texture(),
            transparent: true,
            side: DoubleSide,
